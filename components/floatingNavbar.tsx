          ...
          <div className="flex items-center gap-1">
            {navItems.map((navItem, idx: number) => (
              <a
                ...
                href={navItem.link}
                className={cn(
                  "relative flex items-center gap-1 rounded-full px-4 py-2 text-sm font-medium text-neutral-600 transition-colors hover:bg-blue-500 hover:text-slate-100 dark:text-neutral-300 dark:hover:bg-white/10 dark:hover:text-white duration-100"
                )}
              >
